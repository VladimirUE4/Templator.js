/*
  Markup.js v1.5.21: https://github.com/VladimirUE4/Templator.js
  MIT License
  (c) 2011 - 2025 VladimirUE4
...
var Mark = {
    ...
    _eval: function (context, filters, child) {
        ...
        // Protect context against null/undefined
...
Mark.up = function (template, context, options) {
    ...
    while ((tag = tags[i++])) {
        ...
        // Secure access to context properties.
